...
from home_maintenance.cli import demo_state
from home_maintenance.storage import load_state, save_state
from home_maintenance.models import generate_short_id
from home_maintenance.validation import normalize_tags, require_text, validate_task_status
from home_maintenance.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
